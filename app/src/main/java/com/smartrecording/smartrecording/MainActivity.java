...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_auto = (Button) findViewById(R.id.btnAutoRecord);
        Button btn_manual = (Button) findViewById(R.id.btnManualRecord);
        Button btn_media = (Button) findViewById(R.id.btnMediaRecord);
